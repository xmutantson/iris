...
// O0=0.5, O1=1.0, O2=1.5, O3=2.0, O4=2.5, O5=3.0, O6=3.125, O7=3.75, O8=4.5,
// O9=5.0, O10=6.0, O11=7.0, O12=7.5, O13=8.75.
// O6 = 32QAM r5/8 (3.125 net bpc) is VARA FM narrow's exact top gear — the one
// rung the ladder previously skipped (16QAM r3/4 jumped straight to 64QAM r5/8).
// Dropped 64QAM r1/2 (= 16QAM r3/4 throughput) and 256QAM r1/2 (< 64QAM r3/4).
// This table maps 1:1 to kUniformPresets[] in ofdm_frame.cc AND presets[] in
// make_uniform_tone_map() (ofdm_mod.cc): preset_id = level + 1. Keep all three
// in sync when adding/removing a rung.
const SpeedLevel OFDM_SPEED_LEVELS[NUM_OFDM_SPEED_LEVELS] = {
    ...
    {"O6",   Modulation::QAM32,  5, 8,  20.0f,  0},   // 32QAM r5/8       = 3.125 (NEW: VARA FM narrow top gear)
    {"O7",   Modulation::QAM64,  5, 8,  21.0f,  0},   // 64QAM r5/8       = 3.75
    {"O8",   Modulation::QAM64,   3, 4,  24.0f,  0},   // 64QAM r3/4       = 4.5
    {"O9",   Modulation::QAM256, 5, 8,  27.0f,  0},   // 256QAM r5/8      = 5.0
    {"O10",  Modulation::QAM256,  3, 4,  30.0f,  0},   // 256QAM r3/4      = 6.0
    {"O11",  Modulation::QAM256,  7, 8,  33.0f,  0},   // 256QAM r7/8      = 7.0
    {"O12",  Modulation::QAM1024, 3, 4,  36.0f,  0},   // 1024QAM r3/4     = 7.5
    {"O13",  Modulation::QAM1024, 7, 8,  39.0f,  0},   // 1024QAM r7/8     = 8.75
};
...
int mode_baud_rate(char mode) {
    switch (mode) {
        case 'A': case 'a': return mode_a_config().baud_rate;
